...
>>>>>>> ab18fcba14686d291628c8e176204c2e69bcc3b0
    ...
    makeReservation() {
      this.$router.push({ name: 'reserva-exitosa' });
    }
...
>>>>>>> ab18fcba14686d291628c8e176204c2e69bcc3b0
      ...
      <div class="promo-section">
        ...
        <div class="promo-actions">
          ...
          <pv-button class="promo-button" style="margin-left: 0px; margin-top: 20px;">Agregar</pv-button>
        </div>
      </div>
      <div class="payment-section">
        ...
        <div class="payment-info">
          ...
          <pv-button class="change-payment-button" @click="onChangeShowPaymentForm()">Cambiar</pv-button>
        </div>
      </div>
    </div>
    <div class="container-right">
      ...
      <div class="worker-section">
        ...
        <div class="worker-details">
          ...
          <p>
            Dirección: <span>{{ workers.location }}</span>
          </p>
          <p>
            Valoraciones: <span>{{ workers.valoraciones }}</span>
          </p>
        </div>
      </div>
        ...
        <div class="service-options">
          <div class="service-option">
            <input
              ...
              value="Premium"
              v-model="serviceType"
              @change="changeServiceType('Premium')"
            />
            <label for="premium">Premium</label>
            <p class="service-description">
              Ten un servicio con seguimiento personalizado para tu mascota
            </p>
          ...
          <div class="service-option">
            <input
              ...
              value="Básica"
              v-model="serviceType"
              @change="changeServiceType('Básica')"
            />
      ...
      <div class="payment-summary-section">
        ...
        <div class="payment-details">
          <p>
            Costo de servicio: <span>{{ servicioCost }}</span>
          </p>
          <p>
            Adicionales: <span>{{ adicionalesCost }}</span>
          </p>
          <p>
            Descuento: <span>{{ discount }}</span>
          </p>
          <p>
            Cuota PetCare: <span>{{ cuotaPetCare }}</span>
          </p>
          <p class="total">
          ...
          >
            Realizaremos una reserva a tu método de pago por el valor de la
            orden.
          </p>
        </div>
      </div>
...
<div class="payment-form-overlay" v-if="this.showPaymentForm == true">
