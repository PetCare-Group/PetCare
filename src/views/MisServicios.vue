  ...
  data() {
    return {
      ...
      ultimosServicios: [
        ...
        { id: 2, nombre: "Alberto Poma", tipoServicio: "Paseador", ubicacion: "Miraflores", precio: 30 },
        { id: 3, nombre: "Hiro Cardenas", tipoServicio: "Paseador", ubicacion: "Santiago de Surco", precio: 35 },
      ],
    };
  },
  created() {
